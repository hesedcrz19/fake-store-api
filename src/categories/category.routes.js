...
categoriesRouter.get('/:id/products', asyncHandler(CategoryController.getProductsById))
categoriesRouter.get('/slug/:slug', asyncHandler(CategoryController.getBySlug))
categoriesRouter.get('/slug/:slug/products', asyncHandler(CategoryController.getProductsBySlug))
